    ...
    const categories = [
        {
            ...
            image: "https://images.unsplash.com/photo-1583030230283-7d2d09432684?q=80&w=1000",
        },
        {
            title: "Mugs",
            slug: "mugs",
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1531346878377-a51e1957cf39?q=80&w=1000",
        }
    ];
    ...
    for (const catData of categories) {
        ...
        if (catData.slug === 'frames') {
            products.push({
                ...
                price: 599,
                images: ["https://images.unsplash.com/photo-1582582621959-48d27397dc69?q=80&w=1000"],
                stock: 50,
                featured: true,
            ...
            products.push({
                ...
                price: 799,
                images: ["https://images.unsplash.com/photo-1616593871279-50ebbc9f8746?q=80&w=1000"],
                stock: 50,
                featured: true,
                category: category._id,
                customizationConfig: {
            ...
            products.push({
                ...
                price: 899,
                images: ["https://images.unsplash.com/photo-1578321272182-3747122ad80b?q=80&w=1000"],
                stock: 30,
                featured: true,
                category: category._id,
                customizationConfig: {
            ...
            products.push({
                ...
                price: 399,
                images: ["https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=1000"],
                stock: 100,
                featured: true,
                category: category._id,
                customizationConfig: {
            ...
            products.push({
                ...
                price: 499,
                images: ["https://images.unsplash.com/photo-1577937927133-66ef06acdf18?q=80&w=1000"],
                stock: 50,
                featured: true,
                category: category._id,
                customizationConfig: {
            ...
            products.push({
                ...
                price: 799,
                images: ["https://images.unsplash.com/photo-1531346878377-a51e1957cf39?q=80&w=1000"],
                stock: 100,
                featured: true,
                category: category._id,
                customizationConfig: {
