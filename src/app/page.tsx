      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-black text-white">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter animate-in fade-in slide-in-from-bottom-8 duration-700">
            MODERN <br /> <span className="text-blue-500 italic decoration-wavy underline underline-offset-8">STYLE.</span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-1000 font-black italic uppercase tracking-tight">
            Premium products curated for your daily life. Experience the next generation of shopping.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center p-12 rounded-[3.5rem] bg-card border-2 border-border transition-all hover:border-blue-600 hover:premium-shadow hover:-translate-y-2 group relative overflow-hidden shadow-2xl shadow-black/5">
              ...
              <h3 className="text-3xl font-black mb-6 italic tracking-tight text-foreground uppercase relative z-10">Fast Delivery</h3>
              <p className="text-foreground leading-relaxed font-black text-[10px] tracking-[0.2em] uppercase relative z-10 italic">
                Get your products delivered in record time with our <span className="text-blue-600">pan-India</span> delivery network. Prompt Shipping.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-12 rounded-[3.5rem] bg-card border-2 border-border transition-all hover:border-blue-600 hover:premium-shadow hover:-translate-y-2 group relative overflow-hidden shadow-2xl shadow-black/5">
              ...
              <h3 className="text-3xl font-black mb-6 italic tracking-tight text-foreground uppercase relative z-10">Secure Payments</h3>
              <p className="text-foreground leading-relaxed font-black text-[10px] tracking-[0.2em] uppercase relative z-10 italic">
                Your data is protected by industry-leading <span className="text-blue-600">encryption</span> and secure payment gateways. Zero Risk.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-12 rounded-[3.5rem] bg-card border-2 border-border transition-all hover:border-blue-600 hover:premium-shadow hover:-translate-y-2 group relative overflow-hidden shadow-2xl shadow-black/5">
              ...
              <h3 className="text-3xl font-black mb-6 italic tracking-tight text-foreground uppercase relative z-10">Quality Check</h3>
              <p className="text-foreground leading-relaxed font-black text-[10px] tracking-[0.2em] uppercase relative z-10 italic">
                Every piece is inspected to meet our <span className="text-blue-600">premium standards</span> of finish and craftsmanship. Pure Build.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center md:text-left">
          <div className="max-w-4xl">
            <h2 className="text-5xl md:text-8xl font-black mb-10 italic tracking-tighter leading-none uppercase">
              STAY <br /> <span className="text-blue-600">UPDATED.</span>
            </h2>
